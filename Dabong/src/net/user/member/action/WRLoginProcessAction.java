...
public class WRLoginProcessAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		JSONArray array = vtMemberDAO.getAddressList();
		res.put("positions", array);
		System.out.println(res);
		
		try (FileWriter file = new FileWriter("/Users/shane/git/semi_dabong/Dabong/WebContent/json/volunteerMap.json")) {
			//FileWriter file = new FileWriter("D:\\workspace\\Dabong\\Dabong\\WebContent\\json\\volunteerMap.json"
